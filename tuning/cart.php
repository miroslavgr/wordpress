	...
	<table class="shop_table shop_table_responsive cart woocommerce-cart-form__contents" cellspacing="0">
		<thead>
			<tr>
				...
				<th class=""><?php esc_html_e( 'Description', 'woocommerce' ); ?></th>
				<th style="padding-left:10px" class=""><?php esc_html_e( 'For Car', 'woocommerce' ); ?></th>
			...
			foreach ( WC()->cart->get_cart() as $cart_item_key => $cart_item ) {
				...
				if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
					$product_permalink = 0;
						...
						/*apply_filters( 'woocommerce_cart_item_permalink', $_product->is_visible() ? $_product->get_permalink( $cart_item ) : '', $cart_item, $cart_item_key );*/
					?>
					<tr class="woocommerce-cart-form__cart-item <?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
						...
						<td class="product-name" data-title="<?php esc_attr_e( 'Product', 'woocommerce' ); ?>">
							...
							<div class="fusion-product-name-wrapper">
								...
								<div stlye="display:block;" class="product-info">
									<h3>
									...
									<span style="width:auto" class="product-thumbnail">
									<?php
...
echo do_shortcode('[contact-form-7 id="18620" title="Контакт карта"]');
